...
- AI 剧情短片与分镜前期开发
- 30 秒至 15 分钟的广告、TVC 与品牌故事；品牌 TVC 默认写消费者处境中的品牌广告成片，不写广告制作幕后
- 只有主题、人物或几个画面时的故事起稿
...
我想做一支 60 秒联想昭阳 X5 Air 品牌 TVC：
- 主题：真正的轻，不只是重量更轻
- 主角：一个必须在城市中完成临时任务的普通用户
- 产品卖点：轻薄便携、快速流畅
- 必须出现：一个前 3 秒就发生的具体事件、产品改变行动、结尾品牌露出

请直接写成一条有创意的品牌广告成片，输出核心事件、30–60 秒脚本、产品因果和品牌收束。
不要把比赛、参赛、拍广告、甲方改稿或创作者制作过程写成剧情。
```
